...
import SectionBlock from "../../../../features/aboutUs/SectionBlock";
import VisionSection from "../../../../features/aboutUs/VisionSection";
  ...
  return (
    <>
      ...
      >
        ...
        <strong>meticuloso</strong> en cada detalle y <strong>constante</strong>{" "}
        en nuestro afán por superar tus expectativas."
      </SectionBlock>
